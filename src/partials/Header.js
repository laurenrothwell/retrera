        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden md:flex md:flex-grow">
            ...
            <ul className="flex flex-grow justify-end flex-wrap items-center">
              <li>
                <a class="typeform-share button text-gray-600 hover:text-gray-900 px-3 lg:px-5 py-2 flex items-center transition duration-150 ease-in-out" href="https://form.typeform.com/to/yzf5D1OL?typeform-medium=embed-snippet" data-mode="popup" data-size="100" target="_blank">Plan</a>
              </li>
              <li>
