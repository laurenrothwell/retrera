        ...
        <div className="pb-12 md:pb-20">
          ...
          <div className="bg-blue-600 rounded py-10 px-8 md:py-16 md:px-12 shadow-2xl" data-aos="zoom-y-out">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center">
              ...
              {/* CTA button */}
              <div>
                <a className="typeform-share btn text-blue-600 bg-gradient-to-r from-blue-100 to-white" href="https://form.typeform.com/to/yzf5D1OL?typeform-medium=embed-snippet" data-mode="popup" data-size="100" target="_blank">Sign up now</a>
              </div>
