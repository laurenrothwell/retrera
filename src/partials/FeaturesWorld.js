      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 mb-4">Stay organized and keep employees engaged</h1>
            <p className="text-xl text-gray-600">Your dashboard keeps all employee preferences and activity in one place. Easily access availability, feedback, and employee engagement metrics. </p>
          </div>
          ...
          <div className="flex flex-col items-center pt-12 md:pt-16">
            <div className="relative">
              ...
              {/* Globe image */}
              <img className="relative rounded-full shadow-xl" src={require('../images/planet.png')} width="400" height="400" alt="Planet" />
              {/* Static dots */}
              <svg className="absolute top-0 w-full h-auto" viewBox="0 0 400 400" style={{ left: '12%' }} xmlns="http://www.w3.org/2000/svg">
                ...
                <g transform="translate(0 -.818)" fill="none" fillRule="evenodd">
                  ...
                  <path d="M258 256.2 l 87-29.204" stroke="#666" strokeWidth="2" opacity=".16" filter="url(#world-ill-e)" />
                  <path d="M258 251.333 c 111.333 -40.237 141 -75.282 89 -105.136 M 136 103.364c66.667 4.543 104.667 32.45 114 83.72" stroke="url(#world-ill-f)" strokeWidth="2" strokeDasharray="2" />
                  {/* <path d=" M 100 103.364 c 100 105 91 140 100 150.72" stroke="url(#world-ill-f)" strokeWidth="2" strokeDasharray="2" /> */}
                </g>
              </svg>
              {/* Dynamic dots */}
              ...
              {/* Avatars */}
              <img className="absolute max-w-full transform animate-float" src={require('../images/planet-avatar-01.png')} width="261" height="105" alt="Planet avatar 01" style={{ width: '65.25%', top: '-3%', right: '-27%' }} />
              <img className="absolute max-w-full transform animate-float animation-delay-1000" src={require('../images/planet-avatar-02-new.png')} width="355" height="173" alt="Planet avatar 02" style={{ width: '88.7%', bottom: '-20%', right: '-18%' }} />
